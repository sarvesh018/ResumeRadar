...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="ResumeRadar Tracker Service",
        version="1.0.0",
        docs_url="/api/v1/tracker/docs",
        openapi_url="/api/v1/tracker/openapi.json",
    )
    ...
    app.include_router(v1_router, prefix="/api/v1", tags=["tracker"])

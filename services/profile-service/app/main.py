...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="ResumeRadar Profile Service",
        version="1.0.0",
        docs_url="/api/v1/profile/docs",
        openapi_url="/api/v1/profile/openapi.json",
    )
    ...
    app.include_router(v1_router, prefix="/api/v1", tags=["profile"])
